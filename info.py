...
# Bot information
SESSION = environ.get('SESSION', '@RangaXa_bot')
API_ID = int(environ.get('API_ID', '21529799'))
API_HASH = environ.get('API_HASH', 'a98026ff52821a5c43b0e440b978c131')
BOT_TOKEN = environ.get('BOT_TOKEN', "7435439470:AAG2vmwDwYTb09UgU453lF7jq6UDFDQrf1g")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001983405512'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001827589137').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001715076120') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://storytrain8:ug8mGFU3AbgcPrtV@cluster0.9tgyh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KL55_LINKS')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KL55_LINKS')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/KL55_LINKS) # Support Chat Link Without https:// or @
