...
BOT_TOKEN = environ.get('BOT_TOKEN', "7812112806:AAExwuwagJ8kVZUK8x5fZutgg5YvHl784gI")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/VC1bdsQ/file-50.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002498541249').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001866498735') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001866498735')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1206988513')
...
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://sivaraman:siva444@cluster0.bhuvc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/gEo.jpg') # payment code picture url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', '00eec535be25d87a1d96244502b2d1ec7498f6b0')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Sr_Movie_Links/46') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
