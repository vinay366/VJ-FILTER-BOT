...
PICS = (environ.get('PICS', 'https://telegra.ph/file/5ed708a888f16dd039358.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002085230546') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002239262549')).split()]
...
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '7c05e31feed1f58fe00066964d777b4a286a9a22')
