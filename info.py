...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TCU_TCU')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/3da771cb73778ffec8ed8.jpg') # payment code picture url.
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs - \n\n- 30ʀs - 1 ᴡᴇᴇᴋ\n- 50ʀs - 1 ᴍᴏɴᴛʜs\n- 120ʀs - 3 ᴍᴏɴᴛʜs\n- 220ʀs - 6 ᴍᴏɴᴛʜs\n\n🎁 ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs 🎁\n\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ\n○ ᴅɪʀᴇᴄᴛ ғɪʟᴇs\n○ ᴀᴅ-ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ\n○ ʜɪɢʜ-sᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ\n○ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ sᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋs\n○ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs\n○ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ\n○ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 1ʜ ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ\n\n✨ ᴜᴘɪ ɪᴅ - <code>premlrem023-3@oksbi</code>\n\nᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan\n\n💢 ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ\n\n‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ</b>')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_Request_Groups_File1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TCU_TCU')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'tcu_support') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/VinayMudhiraj')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '3ab0a0baa69ac0405dda82b487d74c046d83dda7')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/tcu_support')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '3ab0a0baa69ac0405dda82b487d74c046d83dda7')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tcu_support') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', '◦•●◉✿ స్వాగతం, ప్రియమైన అతిథి! 🌟 మీ ఉనికితో మన ప్రయాణం జ్ఞానం మరియు ఆనందం తీసుకురావాలి. 🙏 ✿◉●•◦')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-filter-bot-production.up.railway.app/")
