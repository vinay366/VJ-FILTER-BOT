...
<b>Nᴏᴛᴇ :</b>
<b>Mʏ Fᴇᴀᴛᴜʀᴇs Sᴛᴀʏ Hᴇʀᴇ Nᴇᴡ Fᴇᴀᴛᴜʀᴇs Cᴏᴍɪɴɢ Sᴏᴏɴ...</b>
 <b>✯ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ : <a href=https://t.me/Cute_Boy_SaravanaƬɴ69 ×͜× Sᴀʀᴀᴠᴀɴᴀ࿐</a></b>
  
 <b>✯ Jᴏɪɴ Hᴇʀᴇ : <a href=https://t.me/LCUxBOTZ>☢Jᴏɪɴ Mʏ Uᴘᴅᴀᴛᴇᴅs☢</a></b> 
  
 <b>./id - <code>ɢᴇᴛ ɪᴅ ᴏꜰ ᴀ ꜱᴘᴇᴄɪꜰɪᴇᴅ ᴜꜱᴇʀ.</ 
 code> 
...
./font - This command usage stylish and cool font generator [<code>example /font hi</code>]</b>"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>📂Fɪʟᴇ Nᴀᴍᴇ : {caption}</b>

<b> @TamilxLinks X @PMIxOfficials</b>""" 
...
╚═ ██╔══╝██╔════╝██╔════╝██║  ██║     ║██      ██║        ██║
   ...
   ╚═╝    ╚══════╝╚══════╝╚═╝  ╚═╝        ╚════╝   ╚════════╝"""
    ...
    TAMIL_INFO = """
<b>ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த @LCUxAutoFiltersBot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்

 படி 2: உங்கள் இணையதளம் மற்றும் API ஐச் சேர்க்கவும்

 Exp: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
மேலும் உங்கள் குழுவில் பயிற்சி வீடியோ தொகுப்பு ஆகிடும்...</b>"""
    ...
    ENGLISH_INFO = """
<b>Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this @LCUxAutoFiltersBot bot to your group
...
Also your tutorial will be Added Your Group...</b>"""
    ...
    TELUGU_INFO = """
<b>హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ @LCUxAutoFiltersBot బాట్‌ని మీ సమూహానికి నిర్వహించండి

 దశ 2: మీ వెబ్‌సైట్ మరియు APIని జోడించండి

 గడువు: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
అలాగే మీ బృందం వీడియో సేకరణకు శిక్షణ ఇస్తుంది...</b>"""

    HINDI_INFO = """
<b>अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 एक्सप: /शॉर्टलिंक onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
साथ ही आपकी टीम वीडियो संग्रह का प्रशिक्षण भी देगी...</b>"""

    MALAYALAM_INFO = """
<b>ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 കാലഹരണപ്പെടൽ: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും...</b>"""

    URTU_INFO = """
 <b><a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 مرحلہ 1: اپنے گروپ میں اس @LCUxAutoFiltersBot بوٹ کا انتظام کریں۔
...
نیز آپ کی ٹیم ویڈیو جمع کرنے کی تربیت دے گی...</b>"""

    GUJARATI_INFO = """
<b>અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ @LCUxAutoFiltersBot બોટનું સંચાલન કરો

 પગલું 2: તમારી વેબસાઇટ અને API ઉમેરો

 સમાપ્તિ: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
તેમજ તમારી ટીમ વિડિયો કલેક્શનની તાલીમ આપશે...</b>"""

    KANNADA_INFO = """
<b>ಹೇ {message.from_user.mention}
 ...
 ಅವಧಿ: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
ನಿಮ್ಮ ತಂಡವು ವೀಡಿಯೋ ಸಂಗ್ರಹಣೆಗೆ ತರಬೇತಿ ನೀಡಲಿದೆ...</b>"""

    BANGLADESH_INFO = """
<b>আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই @LCUxAutoFiltersBot বট পরিচালনা করুন

 ধাপ 2: আপনার ওয়েবসাইট এবং API যোগ করুন

 মেয়াদ: /shortlink onepageyam.com 61f969bec020fe95a06cbcfd420ef8000479d147
...
এছাড়াও আপনার দল ভিডিও সংগ্রহের প্রশিক্ষণ দেবে...</b>"""
